...
namespace RoadRecordViolationSystem.Migrations
{
    ...
    [Migration("20211120003352_removeEmailInUsersInformation")]
    partial class removeEmailInUsersInformation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RoadRecordViolationSystem.Models.Address", b =>
                {
            ...
            modelBuilder.Entity("RoadRecordViolationSystem.Models.UsersInformation", b =>
                {
                    ...
                    b.ToTable("UsersInformationTable");
                });
            ...
            modelBuilder.Entity("RoadRecordViolationSystem.Models.UsersInformation", b =>
                {
                    b.HasOne("RoadRecordViolationSystem.Models.Address", "Address")
                        .WithOne("UsersInformations")
                        .HasForeignKey("RoadRecordViolationSystem.Models.UsersInformation", "AddressID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("RoadRecordViolationSystem.Models.Address", b =>
                {
                    b.Navigation("UsersInformations");
                });
