...
namespace RoadRecordViolationSystem.Migrations
{
    ...
    [Migration("20220519080748_AddOfficerInvolveTable")]
    partial class AddOfficerInvolveTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RoadRecordViolationSystem.Models.Accident", b =>
                {
                    ...
                    b.Property<string>("AccidentImage")
                        .HasMaxLength(1500)
            ...
            modelBuilder.Entity("RoadRecordViolationSystem.Models.AccidentInvolve", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RoadRecordViolationSystem.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<DateTime?>("ValidTimeToLogin")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("RoadRecordViolationSystem.Models.Contest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("AgainstEnforcer")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ContactNo")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ContestLetterImagePath")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("OrCrImagePath")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ProofContestVideoImagePath")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("RoadRecordViolationSystem.Models.ContestSchedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("ContestApplicationId")
                        .HasColumnType("int");

                    b.Property<DateTime>("HearingScheduleDate")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("HearingScheduleTime")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("ContestApplicationId")
                        .IsUnique();
            ...
            modelBuilder.Entity("RoadRecordViolationSystem.Models.OfficerInvolve", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("OfficerInvolves");
                });

            modelBuilder.Entity("RoadRecordViolationSystem.Models.Settings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("AdditionalChargePerDay")
                        .HasColumnType("int");

                    b.Property<int>("DaysBeforeAdditionalApplies")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RoadRecordViolationSystem.Models.ViolatorTicketInformation", b =>
                {
                    ...
                    b.Property<string>("ViolatorSignatureImagePath")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("RoadRecordViolationSystem.Models.AccidentInvolve", b =>
                {
                    b.HasOne("RoadRecordViolationSystem.Models.Accident", "Accident")
                        .WithMany("AccidentInvolves")
            ...
            modelBuilder.Entity("RoadRecordViolationSystem.Models.ContestSchedule", b =>
                {
                    b.HasOne("RoadRecordViolationSystem.Models.Contest", "Contest")
                        .WithOne("ContestSchedule")
                        .HasForeignKey("RoadRecordViolationSystem.Models.ContestSchedule", "ContestApplicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("RoadRecordViolationSystem.Models.Accident", b =>
                {
                    b.Navigation("AccidentInvolves");

                    b.Navigation("OfficerInvolves");
                });
